...
enum GridFactory {
    ...
    static var superEasyGrid: [CoordinateValue] {
        ...
        let square5 = [(0, 0, 5, 1), (0, 1, 5, 5), (0, 2, 5, 7), (1, 1, 5, 9), (2, 0, 5, 2), (2, 1, 5, 8), (2, 2, 5, 4)]
        let square6 = [(0, 0, 6, 5), (0, 1, 6, 3), (0, 2, 6, 1), (1, 0, 6, 8), (1, 1, 6, 2), (1, 2, 6, 7), (2, 0, 6, 6), (2, 1, 6, 4), (2, 2, 6, 9)]
        let square7 = [(0, 0, 7, 9), (0, 1, 7, 8), (0, 2, 7, 4), (1, 0, 7, 6), (1, 1, 7, 1), (1, 2, 7, 3), (2, 0, 7, 2), (2, 1, 7, 5), (2, 2, 7, 7)]
        let square8 = [(0, 0, 8, 6), (0, 1, 8, 7), (0, 2, 8, 2), (1, 0, 8, 5), (1, 1, 8, 4), (1, 2, 8, 9), (2, 1, 8, 3), (2, 2, 8, 1)]
